...
let BASE_URL = "https://js1-todo-api.vercel.app/api/todos?apikey=edc127b1-02b7-4c0f-95b3-4989c46d8c9d";
...
// Remove todo
  function removeTodo(element) {
    ...
    fetch(`https://js1-todo-api.vercel.app/api/todos/${todoId}?apikey=edc127b1-02b7-4c0f-95b3-4989c46d8c9d`, {
      method: 'DELETE'
    }).then(response => {
        if (response.ok) {
  ...
  fetch("https://js1-todo-api.vercel.app/api/todos?apikey=edc127b1-02b7-4c0f-95b3-4989c46d8c9d", {
    method: 'POST',
